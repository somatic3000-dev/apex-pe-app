...
export default function Reporting({ portfolio = [], fund = {} }) {
    ...
    <div className="fade-in">
      <div className="page-header">
        <div>
          ...
          <div className="page-sub">Quarterly Portfolio Report</div>
        </div>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        ...
        <div style={{ display: "grid", gap: 10, lineHeight: 1.6 }}>
          <div>
            Der Fonds hält aktuell <b>{active.length}</b> aktive Beteiligungen
            und hat <b>{exits.length}</b> realisierte Exits.
          </div>
