...
export default function App() {
  ...
  const sections = NAV.reduce((acc, navItem) => {
    (acc[navItem.section] ||= []).push(navItem);
    return acc;
  }, {});

  function renderPage() {
    return {
      dashboard: <Dashboard fund={fund} portfolio={portfolio} />,
  ...
  return (
    <div className="app">
      <header className="topbar">
        ...
        <span className="badge badge-blue">€{fund.aum || fund.commitments || 0}M AUM</span>
